const products = [
     {                                                     id: "1",
      ...
      verified: true,       stock: true,                                        brand: "Limca"                                              },                                                                        
      {                                                     id: "4",
      ...
      verified: true,       stock: true,                                        brand: "Fanta"                                              },                                 
      {                                                     id: "8",
      ...
      {                                                     id: "12",
        name: "Slice Mango Fruit Juice Drink 600ml", 
        mrp: 45, 
        price: 39,
        image: "Slice Mango Fruit Juice Drink 600ml.jpg", 
         
      verified: true,       stock: true,                                        brand: "Slice"                                              },                                 
      {                                                     id: "13",
      ...
      verified: true,       stock: true,                                        brand: "Cadbury"                                              },                                 
       {                                                     id: "14",
        name: "Complan Nutrition Drink Powder For Kids Royale Chocolate Flavour 500g", 
        mrp: 329, 
        price: 319,
        image: "Complan Nutrition Drink Powder For Kids Royale Chocolate Flavour 500g.jpg", 
         
      verified: true,       stock: true,                                        brand: "Complan"                                              },                                 
      {                                                     id: "15",
      ...
      {                                                     id: "16",
        name: "Glucon D Instant Energy Health Drink Tangy Orange 200g", 
        mrp: 83, 
        price: 79,
      ...
      {                                                     id: "19",
        name: "Parle Fab Bournbon Biscuits 500g", 
        mrp: 160, 
        price: 99,
      ...
      verified: true,       stock: true,                                        brand: "Unibic"                                              },                                 
      {                                                     id: "21",
      ...
      verified: true,       stock: true,                                        brand: "Kissan"                                              },                                 
      {                                                     id: "33",
        name: "Kissan Fresh Tomato Ketchup (Sauce) 415g", 
        mrp: 55, 
        price: 49,
      ...
      verified: true,       stock: true,                                        brand: "Bikaji"                                              },                                 
      {                                                     id: "39",
        name: "Bikaji Potato Chips Mast Masala 100g", 
        mrp: 50, 
        price: 39,
      ...
      verified: true,       stock: true,                                        brand: "Bikaji"                                              },                                 
       {                                                     id: "42",
        name: "Bikaji Potato Chips Classic Salted 100g", 
        mrp: 50, 
        price: 29,
      ...
      verified: true,       stock: true,                                        brand: "Bikaji"                                              },                                 
      {                                                     id: "44",
        name: "Kurkure Masala Munch 38g (Pack of 3)", 
        mrp: 30, 
        price: 29,
      ...
      {                                                     id: "45",
        name: "Kurkure Chilli Chatka 36g (Pack of 3)", 
        mrp: 30, 
        price: 29,
      ...
      verified: true,       stock: true,                                        brand: "Kurkure"                                              },                                 
      {                                                     id: "46",
        name: "Kurkure Solid Masti Masala Twistees 30g (Pack of 3)", 
        mrp: 30, 
        price: 29,
      ...
      verified: true,       stock: true,                                        brand: "Kurkure"                                              },                                 
      {                                                     id: "47",
        name: "Lays West Indies Hot n Sweet Chilli Potato Chips 24g (Pack of 3)", 
        mrp: 30, 
        price: 29,
        image: "Lays West Indies Hot n Sweet Chilli Potato Chips 24g (Pack of 3).jpg", 
         
      verified: true,       stock: true,                                        brand: "Lays"                                              },                                 
      {                                                     id: "48",
        name: "Lays Indias Magic Masala Potato Chips 24g (Pack of 3)", 
        mrp: 30, 
        price: 29,
      ...
      verified: true,       stock: true,                                        brand: "Lays"                                              },                                 
       {                                                     id: "49",
        name: "Lays Spanish Tomato Tango Flavour Potato Chips 24g (Pack of 3)", 
        mrp: 30, 
        price: 29,
      ...
      verified: true,       stock: true,                                        brand: "Lays"                                              },                                 
      {                                                     id: "50",
        name: "Lays American Style Cream & Onion Flavour Potato Chips 24g (Pack of 3)", 
        mrp: 30, 
        price: 29,
      ...
      verified: true,       stock: true,                                        brand: "Lays"                                              },                                 
      {                                                     id: "51",
        name: "Lays Classic Salted Potato Chips 24g (Pack of 3)", 
        mrp: 30, 
        price: 29,
      ...
      verified: true,       stock: true,                                        brand: "Bikaji"                                              },                                 
      {                                                     id: "53",
        name: "Maggi 2-Minute Masala Noodles 280g", 
        mrp: 69, 
        price: 59,
      ...
      verified: true,       stock: true,                                        brand: "Maggi"                                              },                                 
      {                                                     id: "56",
        name: "Parle Kaccha Mango Bite Candy (Toffee) 198g", 
        mrp: 50, 
        price: 49,
      ...
      verified: true,       stock: true,                                        brand: "Parle"                                              },                                 
      {                                                     id: "57",
        name: "Parle Melody Chocolaty  (Toffee) 195.5g", 
        mrp: 50, 
        price: 49,
      ...
      verified: true,       stock: true,                                        brand: "Parle"                                              },                                 
      {                                                     id: "58",
        name: "Parle Kismi Candy (Toffee) 276.36g", 
        mrp: 50, 
        price: 49,
      ...
      verified: true,       stock: true,                                        brand: "Parle"                                              },                                 
      {                                                     id: "59",
        name: "Horlicks Chocolate Delight 750g", 
        mrp: 370, 
        price: 299,
      ...
      verified: true,       stock: true,                                        brand: "Horlicks"                                              },                                 
      {                                                     id: "61",
        name: "Horlicks Chocolate Delight Jar 500g", 
        mrp: 299, 
        price: 249,
      ...
      verified: true,       stock: true,                                        brand: "Horlicks"                                              },                                 
      {                                                     id: "62",
        name: "Eno Fruit Salt - Lemon, 30g (Pack of 6)", 
        mrp: 65, 
        price: 59,
        image: "Eno Fruit Salt - Lemon, 30g (Pack of 6).jpg", 
         
      verified: true,       stock: true,                                        brand: "Eno"                                              },
      ...
      verified: true,       stock: true,                                        brand: "Dabur"                                              },                                 
      {                                                     id: "72",
        name: "Engine Brand Kachi Ghani Mustard Oil 1L", 
        mrp: 210, 
        price: 189,
        image: "Engine Brand Kachi Ghani Mustard Oil 1L.jpg", 
         
      verified: true,       stock: true,                                        brand: "Engine"                                              },                                  
       {                                                     id: "73",
      ...
      {                                                     id: "76",
        name: "Lal Qilla Basmati Rice 1Kg", 
        mrp: 280, 
        price: 159,
        image: "Lal Qilla Basmati Rice 1Kg.jpg", 
         
      verified: true,       stock: false,                                        brand: "Lal Qilla"                                              },                                 
       {                                                     id: "77",
        name: "Laxmi Bhog Atta 5Kg", 
        mrp: 255, 
        price: 209,
      ...
      verified: true,       stock: true,                                        brand: "Everest"                                              },                                 
      {                                                     id: "84",
        name: "Everest Sabji Masala 100g", 
        mrp: 72, 
        price: 64,
      ...
      verified: true,       stock: true,                                        brand: "Everest"                                              },                                 
      {                                                     id: "85",
        name: "Everest Kashmirilal 100g (Red Chilli Powder)", 
        mrp: 110, 
        price: 99,
      ...
      {                                                     id: "99",
        name: "Brooke Bond Taaza Leaf Tea 1Kg", 
        mrp: 250, 
        price: 209,
      ...
      {                                                     id: "101",
        name: "Nescafe Classic Coffee Jar 24g", 
        mrp: 110, 
        price: 104,
      ...
      verified: true,       stock: true,                                        brand: "BRU"                                              },                                 
      {                                                     id: "104",
      ...
      verified: true,       stock: false,                                        brand: "Nescafe"                                              },                                 
      {                                                     id: "105",
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "120",
        name: "Pampers Baby Pants With Aloe Vera Small (S) 4-8kg 40 Pants", 
        mrp: 399, 
        price: 379,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "121",
        name: "Pampers Baby Pants New Baby (NB) Upto 5kg 10 Pants", 
        mrp: 99, 
        price: 99,
      ...
      {                                                     id: "122",
        name: "Pampers Baby Pants With Aloe Vera Medium (M) 7-12kg 8 Pants", 
        mrp: 99, 
        price: 94,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "124",
        name: "Pampers New Xtra Large - 6 Diaper Pants", 
        mrp: 210, 
        price: 189,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
       {                                                     id: "126",
        name: "Pampers Baby Pants With Aloe Vera Small (S) 4-8kg 10 Pants", 
        mrp: 99, 
        price: 94,
      ...
      {                                                     id: "131",
        name: "MamyPoko Pants Extra Absorb Medium (M) 6pc", 
        mrp: 99, 
        price: 94,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "133",
        name: "MamyPoko Pants Extra Absorb Extra Large (XL) 4pc", 
        mrp: 90, 
        price: 84,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "138",
        name: "Himalaya Baby Hair Oil 50ml", 
        mrp: 80, 
        price: 74,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "139",
        name: "Johnsons Baby No More Tears Baby Shampoo 100ml", 
        mrp: 115, 
        price: 109,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "141",
        name: "Johnsons baby Powder Natural 200g", 
        mrp: 230, 
        price: 219,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "146",
        name: "Pampers Baby Pants With Aloe Vera Large (L) 9-14kg buy 6 get 1 Free Pants", 
        mrp: 55, 
        price: 49,
      ...
      {                                                     id: "147",
        name: "Linc Pentonic Multi Ink Colour Pen (Pack of 12, Multicolor)", 
        mrp: 150, 
        price: 139,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "149",
        name: "NATARAJ 621 BOLD HB WRITING PENCILS (Pack of 10)", 
        mrp: 56, 
        price: 49,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "157",
        name: "Casio MJ-120D 150 Steps Check and Correct Desktop Calculator with Tax Keys", 
        mrp: 555, 
        price: 499,
     ...
     {                                                     id: "158",
      ...
      {                                                     id: "161",
        name: "Glow & Lovely Advanced Multivitamin Face Cream 25g", 
        mrp: 65, 
        price: 64,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "165",
        name: "Vaseline Deep Moisture Body Lotion 90ml", 
        mrp: 90, 
        price: 89,
      ...
      {                                                     id: "166",
        name: "Ponds Magic Freshness Talc Powder 100g", 
        mrp: 135, 
        price: 129,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "167",
        name: "Ponds Dreamflower Talcum Powder 100g", 
        mrp: 120, 
        price: 109,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "178",
        name: "Fogg Napoleon Perfume Body Spray For Men 120 ml", 
        mrp: 225, 
        price: 149,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "179",
        name: "DENVER Pride Deodorant (Body Spray For Men) 165ml", 
        mrp: 229, 
        price: 149,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "180",
        name: "DENVER Black Code Deo (Bodyspray for Men) 150ML", 
        mrp: 230, 
        price: 149,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "181",
        name: "DENVER Hamilton Deodorant (Body Spray For Men) 165 ml", 
        mrp: 230, 
        price: 149,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "182",
        name: "DENVER Imperial Deodorant (Body Spray For Men) 165ml", 
        mrp: 230, 
        price: 149,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "183",
        name: "Fogg Dynamic Deodrant 150ml (No Gas Perfume Body Spray For Men)", 
        mrp: 299, 
        price: 169,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "186",
        name: "Gillette Regular Shaving Foam 50g", 
        mrp: 225, 
        price: 149,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "188",
        name: "Gillette Series Shave Gel For Sensitive Skin With Aloe 25g", 
        mrp: 49, 
        price: 49,
      ...
      {                                                     id: "190",
        name: "Gillette Guard Cartridge (Pack Of 4)", 
        mrp: 48, 
        price: 44,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "192",
        name: "Gillette Guard Cartridge (Pack Of 8)", 
        mrp: 84, 
        price: 79,
      ...
      {                                                     id: "197",
        name: "Tide Double Power Lemon & Mint Detergent Powder 4Kg with 1Kg FREE", 
        mrp: 800, 
        price: 599,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "200",
        name: "Tide Double Power Jasmine & Rose Detergent Powder 1Kg with 100g FREE", 
        mrp: 180, 
        price: 129,
      ...
      {                                                     id: "231",
        name: "Whisper Choice XL (18 Pads)", 
        mrp: 126, 
        price: 109,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "232",
        name: "Stayfree Secure Cottony Soft Regular (6 Pads) Sanitary Pads", 
        mrp: 34, 
        price: 34,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "233",
        name: "Veet Professional Ready To Use Half Body Wax Strips 8 Wax Strips & 2 Perfect Finishin Wipes", 
        mrp: 115, 
        price: 109,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
       {                                                     id: "239",
        name: "Whisper Choice Ultra XL plus Sanitary Pads (20 Pads)", 
        mrp: 160, 
        price: 149,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "241",
        name: "Whisper Ultra Hygiene with Comfort XL plus (15 Pads) Sanitary Pads", 
        mrp: 240, 
        price: 179,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
       {                                                     id: "243",
        name: "Whisper Ultra Bindazzz Nights XL plus (15 Pads) Sanitary Pads", 
        mrp: 240, 
        price: 189,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "244",
        name: "Whisper Ultra Heavy Flow Protection No Gap No Leaks Sanitary Pads,XL 30pcs", 
        mrp: 350, 
        price: 299,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "247",
        name: "Whisper Ultra Hygiene with Comfort XL plus Sanitary Pads (30 Pads)", 
        mrp: 480, 
        price: 339,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "249",
        name: "Whisper Ultra Soft Sanitary Pads (45 Pads) Buy 2 Get 1 Free", 
        mrp: 480, 
        price: 449,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "252",
        name: "Patanjali Dant Kanti Natural Toothpaste 100g", 
        mrp: 60, 
        price: 59,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
       {                                                     id: "258",
        name: "Oral-B Criss Cross Charcoal Sensitive Toothbrush, Extra Soft, 1pc", 
        mrp: 95, 
        price: 79,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "259",
        name: "Oral-B Crisscross Soft ToothBrush 1pc", 
        mrp: 95, 
        price: 79,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "260",
        name: "Colgate Gentle Sensitive Ultra Soft 1pc", 
        mrp: 65, 
        price: 39,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "263",
        name: "Colgate Strong Teeth Toothpaste 100g with 15g Extra", 
        mrp: 70, 
        price: 49,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "264",
        name: "Patanjali Dant Kanti Natural Toothpaste 200g", 
        mrp: 115, 
        price: 109,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "272",
        name: "Hair & Care Hair Oil Triple Blend Aloe Vera Olive Oil & Green Tea 200ml", 
        mrp: 120, 
        price: 109,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "274",
        name: "Kesh King Ayurvedic Scalp and Hair Oil 300ml(200ml with 100ml Extra)", 
        mrp: 375, 
        price: 339,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "275",
        name: "Bajaj Almond Drops 6X Vitamin E Hair Oil 114ml", 
        mrp: 72, 
        price: 69,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "279",
        name: "Head & Shoulders Silky Black Anti Dandruff Shampoo 340ml", 
        mrp: 410, 
        price: 299,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "281",
        name: "Head & Shoulders Anti Hair Fall Anti Dandruff Shampoo 340ml", 
        mrp: 499, 
        price: 309,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "285",
        name: "Head & Shoulders Anti Hair Fall Anti Dandruff Shampoo 650ml", 
        mrp: 930, 
        price: 549,
    ...
    {                                                     id: "291",
        name: "Jo Lime Soap 100g (Pack Of 5)", 
        mrp: 120, 
        price: 99,
    ...
    {                                                     id: "296",
        name: "Pears Pure & Gentle Soap Bar 125g (Pack Of 3)", 
        mrp: 235, 
        price: 199,
    ...
    {                                                     id: "298",
        name: "Jo Almond & Cream Soap 100g (Pack Of 5)", 
        mrp: 120, 
        price: 99,
    ...
    {                                                     id: "299",
        name: "Lifebuoy Lemon Fresh Soap Bar 125g - (Pack Of 7) - Mega Value Pack", 
        mrp: 370, 
        price: 199,
    ...
    {                                                     id: "300",
      ...
      {                                                     id: "301",
        name: "Dettol Original Soap 100g (Pack Of 5)", 
        mrp: 260, 
        price: 169,
    ...
    {                                                     id: "303",
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "304",
        name: "Pears Soft & Fresh Soap Bar 100g", 
        mrp: 60, 
        price: 59,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "305",
        name: "Dettol Cologne Fresh Soap Bar 100g (Pack Of 4)", 
        mrp: 208, 
        price: 139,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },                                 
      {                                                     id: "306",
        name: "Lifebuoy Total Soap Bar 125g - BUY 4 GET 1 FREE", 
        mrp: 165, 
        price: 159,
      ...
      {                                                     id: "312",
        name: "Dove daily shine shampoo pouch pack of 8", 
        mrp: 16, 
        price: 15,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "313",
        name: "clinic plus shampoo pouch pack of 10", 
        mrp: 10, 
        price: 9,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "314",
        name: "chick shampoo pouch pack of 5", 
        mrp: 5, 
        price: 5,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "315",
        name: "Bajaj almonds hair oil pouch pack of 6", 
        mrp: 6, 
        price: 6,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "317",
        name: "ponds dreamflower fragrant talc 20gm", 
        mrp: 15, 
        price: 10,
        image: "ponds dreamflower fragrant talc 20gm.jpg", 
         
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "318",
        name: "lifebuoy total soap 45gm", 
        mrp: 10, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "319",
        name: "Dettol original soap 45gm", 
        mrp: 10, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "320",
        name: "Colgate strong teeth amino Shakti toothpaste 18gm", 
        mrp: 15, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "321",
        name: "closeup everfresh plus plus toothpaste 18gm", 
        mrp: 15, 
        price: 10,
      ...
      {                                                     id: "324",
        name: "Godrej no.1 Lime Aloe vera soap 47 gm (pack of 1)", 
        mrp: 10, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "325",
        name: "Alpenliebe Eclairs Plus Toffee 3.4 gm (pack of 5)", 
        mrp: 5, 
        price: 5,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "326",
        name: "Parle Fusion Mango Float Toffee 3.5 gm (pack of 5)", 
        mrp: 5, 
        price: 5,
      ...
      verified: true,       stock: true,                                        brand: "Alpenliebe"                                              },
      {                                                     id: "328",
        name: "Parle Monaco Crispy Light Salty Snacks (Biscuits) 26.1 gm with 2.9 gm Extra (pack of 1)", 
        mrp: 5, 
        price: 5,
      ...
      verified: true,       stock: true,                                        brand: "Rajshree"                                              },
       {                                                     id: "330",
        name: "Parle G Original Gluco Biscuit biscuits 50 gm (pack of 1)", 
        mrp: 5, 
        price: 5,
      ...
      verified: true,       stock: true,                                        brand: "Parle"                                              },
      {                                                     id: "331",
        name: "Saras Chhachh 500 ml (pack of 1)", 
        mrp: 17, 
        price: 16,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "333",
        name: "Amul Buttermilk (Chhachh) 450 ml (pack of 1)", 
        mrp: 17, 
        price: 18,
      ...
      {                                                     id: "335",
        name: "Fru Bon Pasteurised Double Toned Milk 200ml (pack of 1)", 
        mrp: 12, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Dabur"                                              },
      {                                                     id: "339",
        name: "Pulse Shots Kachcha Aam Candy with Tangy Twist Toffee pouch (pack of 1)", 
        mrp: 5, 
        price: 5,
        image: "Pulse Shots Kachcha Aam Candy with Tangy Twist Toffee pouch (pack of 1).jpg", 
         
      verified: true,       stock: true,                                        brand: "Pulse"                                              },
       {                                                     id: "340",
      ...
      {                                                     id: "343",
        name: "Duracell Alkaline AAA Batteries, (for tv remote) (Pack of 2)", 
        mrp: 59, 
        price: 49,
      ...
      verified: true,       stock: true,                                        brand: "Mortein"                                              },
       {                                                     id: "348",
        name: "Mortein 45 ml Refill with Machine, (pack of 1)", 
        mrp: 99, 
        price: 84,
      ...
      verified: true,       stock: true,                                        brand: "Mortein"                                              },
      {                                                     id: "349",
        name: "Amber Eclairs Candy (Toffee)", 
        mrp: 5, 
        price: 5,
        image: "Amber Eclairs Candy (Toffee).jpg", 
         
      verified: true,       stock: true,                                        brand: "Amber"                                              },
      {                                                     id: "350",
        name: "Vijayvargiya Rubi Tea 25 gm (pack of 1)", 
        mrp: 15, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "353",
        name: "Eno Fruit Salt Lemon Flavour 6 gm pouch (pack of 1)", 
        mrp: 12, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Eno"                                              },
       {                                                     id: "354",
        name: "Brooke bond taza tea 100 gm (pack of 1)", 
        mrp: 30, 
        price: 25,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
       {                                                     id: "356",
        name: "Karkal (chanori) 250 gm pack", 
        mrp: 25, 
        price: 20,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
       {                                                     id: "366",
        name: "Maida 1 kg pack", 
        mrp: 45, 
        price: 39,
        image: "Maida 1 kg pack.jpg", 
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "369",
        name: "Amul Taza Milky Milk 500 ml (pack of 1)", 
        mrp: 27, 
        price: 26,
      ...
      verified: true,       stock: true,                                        brand: "Saras"                                              },
       {                                                     id: "372",
        name: "Saras Pasteurised Milk 500 ml Pouch (pack of 1)", 
        mrp: 27, 
        price: 26,
      ...
      verified: true,       stock: true,                                        brand: "Saras"                                              },
      {                                                     id: "373",
        name: "Lays American Style Cream & Onion Flavour Potato Chips 24g (Pack of 1)", 
        mrp: 10, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Lays"                                              },
       {                                                     id: "374",
        name: "Lays Yourgt and Herbs Chips 48 gm (pack of 1)", 
        mrp: 20, 
        price: 19,
      ...
      verified: true,       stock: true,                                        brand: "Kurkure"                                              },
       {                                                     id: "378",
        name: "Bingo Tedhe Medhe Masala Tadka Snacks (Kurkure) 24 gm (pack of 1)", 
        mrp: 5, 
        price: 5,
      ...
      verified: true,       stock: true,                                        brand: "Vim"                                              },
      {                                                     id: "390",
        name: "Vim Bar 300 gm (pack of 1)", 
        mrp: 30, 
        price: 29,
        image: "Vim Bar 300 gm (pack of 1).jpg", 
      ...
      verified: true,       stock: true,                                        brand: "Harpic"                                              },
      {                                                     id: "397",
        name: "Ghadi Detergent Bar 300 gm (pack of 1)", 
        mrp: 21, 
        price: 14,
      ...
      verified: true,       stock: true,                                        brand: "Ghadi"                                              },
       {                                                     id: "398",
        name: "Ghadi Detergent Powder 500 gm (pack of 1)", 
        mrp: 36, 
        price: 34,
      ...
      verified: true,       stock: true,                                        brand: "Rin"                                              },
       {                                                     id: "402",
        name: "Surf Excel Easy Wash Powder 500 gm (pack of 1)", 
        mrp: 67, 
        price: 64,
      ...
      verified: true,       stock: true,                                        brand: "Surf Excel"                                              },
       {                                                     id: "411",
        name: "Eveready Red 1012 Aaa Carbon Zinc Batteries (Pack Of 4)", 
        mrp: 65, 
        price: 55,
        image: "Eveready Red 1012 Aaa Carbon Zinc Batteries (Pack Of 4).jpg", 
      ...
      verified: true,       stock: true,                                        brand: "Cello"                                              },
       {                                                     id: "423",
        name: "Pentonic Ball Pen Blue Ink (Pack Of 10)", 
        mrp: 120, 
        price: 114,
      ...
      verified: true,       stock: true,                                        brand: "Pentonic"                                              },
      {                                                     id: "424",
        name: "Notebook (Single Line) - 84 Pages (pack of 3)", 
        mrp: 120, 
        price: 99,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
       {                                                     id: "425",
        name: "Pentonic 0.6 mm Gel Pen Blue (Pack of 10)", 
        mrp: 120, 
        price: 114,
      ...
      verified: true,       stock: true,                                        brand: "Pentonic"                                              },
      {                                                     id: "426",
        name: "Cello Winner Ball Pen Black (Pack of 5)", 
        mrp: 30, 
        price: 24,
      ...
      verified: true,       stock: true,                                        brand: "Cello"                                              },
       {                                                     id: "427",
        name: "Cello Winner Ball Pen Blue (Pack of 5)", 
        mrp: 35, 
        price: 24,
      ...
      {                                                     id: "429",
        name: "FLAIR Platinum Series Noir Designer Metal Ball Pen Box Pack", 
        mrp: 125, 
        price: 99,
      ...
      verified: true,       stock: true,                                        brand: "FLAIR"                                              },
       {                                                     id: "430",
        name: "DOMS X1 Xtra Super Dark Pencils Box 10 unit Pack ", 
        mrp: 65, 
        price: 54,
      ...
      verified: true,       stock: true,                                        brand: "Amul"                                              },
       {                                                     id: "432",
        name: "Johnsons Baby Lotion 100 ml (pack of 1)", 
        mrp: 120, 
        price: 109,
        image: "Johnsons Baby Lotion 100 ml (pack of 1).jpg", 
         
      verified: true,       stock: true,                                        brand: "Johnsons"                                              },
      {                                                     id: "433",
      ...
      {                                                     id: "440",
        name: "Himalaya Purifying Neem Facewash 50 ml", 
        mrp: 86, 
        price: 79,
      ...
      {                                                     id: "442",
        name: "Tulips Paper Stick Cotton Buds (Jar) 100 Pieces", 
        mrp: 39, 
        price: 32,
        image: "Tulips Paper Stick Cotton Buds (Jar) 100 Pieces.jpg", 
      ...
      {                                                     id: "445",
        name: "Ponds Pure Detox Facewash 50 gm", 
        mrp: 125, 
        price: 119,
      ...
      verified: true,       stock: true,                                        brand: "Colgate"                                              },
      {                                                     id: "450",
        name: "Colgate Active Salt Toothpaste 100 gm", 
        mrp: 79, 
        price: 74,
      ...
      {                                                     id: "454",
        name: "Lux Radiant Glow Vitamin C,E Soap 41 Gm (Pack Of 4)", 
        mrp: 40, 
        price: 39,
      ...
      verified: true,       stock: true,                                        brand: "Dettol"                                              },
      {                                                     id: "470",
        name: "Godrej No 1 Sandal & Turmeric Soap 53 gm (Pack Of 4)", 
        mrp: 40, 
        price: 39,
      ...
      verified: true,       stock: true,                                        brand: "Dove"                                              },
      {                                                     id: "487",
      ...
      verified: true,       stock: true,                                        brand: "Dabur"                                              },
      {                                                     id: "490",
        name: "Dabur Sarson AMla Hair Oil 175 ml", 
        mrp: 65, 
        price: 59,
      ...
      verified: true,       stock: true,                                        brand: "Maggi"                                              },
      {                                                     id: "496",
        name: "Lays Classic Salted 18.5 with Get 5.5 gm", 
        mrp: 10, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Frooti"                                              },
      {                                                     id: "503",
        name: "Limca Soft Drink Pet 250 ml", 
        mrp: 20, 
        price: 19,
      ...
      verified: true,       stock: true,                                        brand: "Brooke Bond"                                              },
      {                                                     id: "532",
        name: "Cinthol Lime Bath Soap 100 gm (pack of 1)", 
        mrp: 45, 
        price: 39,
      ...
      verified: true,       stock: true,                                        brand: "Amul"                                              },
      {                                                     id: "534",
        name: "Navratna Cool Hair Oil, 50ml (Pack of 1)", 
        mrp: 55, 
        price: 44,
      ...
      verified: true,       stock: true,                                        brand: "Navratna"                                              },
      {                                                     id: "535",
        name: "Cadbury Dairy Milk Chocolate Bar, 11.5 gm (Pack of 1)", 
        mrp: 10, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Cadbury"                                              },
      {                                                     id: "536",
        name: "Cadbury Dairy Milk Chocolate Bar, 21 gm (Pack of 1)", 
        mrp: 20, 
        price: 20,
      ...
      verified: true,       stock: true,                                        brand: "Cadbury"                                              },
      {                                                     id: "537",
        name: "Cadbury 5 Star Chocolate Bar, 38 gm (Pack of 1)", 
        mrp: 30, 
        price: 25,
      ...
      {                                                     id: "539",
        name: "Nihar Naturals Shanti Badam Amla Hair Oil, 140ml (Pack of 1)", 
        mrp: 56, 
        price: 49,
      ...
      verified: true,       stock: true,                                        brand: "Nihar"                                              },
      {                                                     id: "540",
        name: "Parle G Gold Biscuits, 200g (Pack of 1)", 
        mrp: 35, 
        price: 29,
      ...
      verified: true,       stock: true,                                        brand: "Parle"                                              },
      {                                                     id: "542",
        name: "Parle G Original Glucose Biscuits, 100 gm (Pack of 1)", 
        mrp: 12, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Gillette"                                              },
      {                                                     id: "547",
        name: "Classmate Long Exercise Note Book - Single Line, 140 Pages", 
        mrp: 70, 
        price: 64,
      ...
      {                                                     id: "549",
        name: "Colgate MaxFresh Toothpaste, Red Gel Tooth Paste with Menthol for Super Fresh Breath 70 gm with 11 gm extra (Pack of 1)", 
        mrp: 78, 
        price: 69,
      ...
      verified: true,       stock: true,                                        brand: "Dabur"                                              },
      {                                                     id: "553",
        name: "Colgate Toothpaste Active Salt 50 gm (Pack of 1)", 
        mrp: 37, 
        price: 25,
      ...
      verified: true,       stock: true,                                        brand: "Colgate"                                              },
      {                                                     id: "554",
        name: "Colgate Dental Cream Anticavity Toothpaste 36 gm (Pack of 1)", 
        mrp: 23, 
        price: 20,
      ...
      verified: true,       stock: true,                                        brand: "Colgate"                                              },
      {                                                     id: "555",
        name: "Colgate Zig Zag Soft Bristles Anti Bacterial Toothbrush (Pack of 1)", 
        mrp: 25, 
        price: 20,
      ...
      verified: true,       stock: true,                                        brand: "Colgate"                                              },
      {                                                     id: "556",
        name: "Himalaya - A Complete Combo of Baby Cream Baby Powder & Baby Hair Oil 100ml Each (combo pack)", 
        mrp: 410, 
        price: 379,
      ...
      verified: true,       stock: true,                                        brand: "Himalaya"                                              },
      {                                                     id: "557",
        name: "NIVEA Lip Balm Original Care 4.8gm (Pack of 1)", 
        mrp: 55, 
        price: 40,
      ...
      verified: true,       stock: true,                                        brand: "NIVEA"                                              },
      {                                                     id: "558",
        name: "Himalaya Herbal Lip Balm 10 gm (Pack of 1)", 
        mrp: 59, 
        price: 40,
      ...
      verified: true,       stock: true,                                        brand: "Amul"                                              },
      {                                                     id: "562",
        name: "Pepsi Soft Drink 2.25L Bottle (Pack of 1)", 
        mrp: 122, 
        price: 117,
      ...
      verified: true,       stock: true,                                        brand: "Patanjali"                                              },
      {                                                     id: "572",
        name: "MDH Turmeric powder (Haldi powder) 100gm (Pack of 1)", 
        mrp: 40, 
        price: 35,
      ...
      verified: true,       stock: true,                                        brand: "MDH"                                              },
      {                                                     id: "573",
        name: "Tata Sampann High Protein Daliya 400 Grams (Pack of 1)", 
        mrp: 42, 
        price: 35,
      ...
      verified: true,       stock: true,                                        brand: "Tata Sampann"                                              },
      {                                                     id: "578",
        name: "Bru Instant Coffee Sachet Ground 8G (Pack of 1)", 
        mrp: 15, 
        price: 9,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "579",
        name: "Nescafe Sunrise Instant Coffee Chicory Mix 9g Pack", 
        mrp: 45, 
        price: 30,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "601",
        name: "Black Grapes (Kale Angoor) 500 gm", 
        mrp: 145, 
        price: 127,
      ...
      verified: true,       stock: true,                                        brand: "Himalaya"                                              },
      {                                                     id: "625",
        name: "Boroplus Ayurvedic Antiseptic Cream 19 gm pack", 
        mrp: 45, 
        price: 42,
        image: "Boroplus Ayurvedic Antiseptic Cream 19 gm pack.jpg", 
         
      verified: true,       stock: true,                                        brand: "Boroplus"                                              },
      {                                                     id: "626",
        name: "Vicks candy (Toffee) 2 gm (pack of 3)", 
        mrp: 3, 
        price: 3,
        image: "Vicks candy (Toffee) 2 gm (pack of 3).jpg", 
         
      verified: true,       stock: true,                                        brand: "Vicks"                                              },
      {                                                     id: "627",
        name: "Dabur Aamla Sarso Oil (Tel) 30 ml (pack of 1)", 
        mrp: 15, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Dabur"                                              },
      {                                                     id: "628",
        name: "Oyes Delicious Puffs Cocktail 18 gm pack", 
        mrp: 5, 
        price: 5,
        image: "Oyes Delicious Puffs Cocktail 18 gm pack.jpg", 
         
      verified: true,       stock: true,                                        brand: "Oyes"                                              },
      {                                                     id: "629",
        name: "Parle Melody Chocolaty Candy (Toffee) 5 gm (pack of 5)", 
        mrp: 5, 
        price: 5,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "630",
        name: "Nihar Naturals Shanti Aamla Hair Oil 70 ml (pack of 1)", 
        mrp: 20, 
        price: 19,
      ...
      verified: true,       stock: true,                                        brand: "Dabur"                                              },
      {                                                     id: "632",
        name: "Cello Butterflow Blue colour pen (pack of 1)", 
        mrp: 6, 
        price: 5,
      ...
      verified: true,       stock: true,                                        brand: "Cello"                                              },
      {                                                     id: "633",
        name: "Flair Writo Meter Jumbo Gel Pen (pack of 1)", 
        mrp: 30, 
        price: 24,
      ...
      verified: true,       stock: true,                                        brand: "Flair"                                              },
      {                                                     id: "634",
        name: "Linc Pentonic black colour pen (pack of 1)", 
        mrp: 12, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Linc"                                              },
      {                                                     id: "635",
        name: "Linc Pentonic blue colour pen (pack of 1)", 
        mrp: 12, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Linc"                                              },
      {                                                     id: "636",
        name: "Montex Smooth Flow Glide Ink blue colour pen (pack of 1)", 
        mrp: 6, 
        price: 5,
        image: "Montex Smooth Flow Glide Ink blue colour pen (pack of 1).jpg", 
         
      verified: true,       stock: true,                                        brand: "Montex"                                              },
      {                                                     id: "637",
        name: "Vim Soap Bar 175 gm (pack of 1)", 
        mrp: 10, 
        price: 10,
      ...
      verified: true,       stock: true,                                        brand: "Vim"                                              },
      {                                                     id: "638",
        name: "Lifebuoy Germs Protection Soap Bar 125 gm (pack of 1)", 
        mrp: 40, 
        price: 37,
      ...
      verified: true,       stock: true,                                        brand: "UNKNOWN"                                              },
      {                                                     id: "639",
        name: "Brinton 1.2 Mtr Micro USB Data Cable (Fast Cahrging)", 
        mrp: 135, 
        price: 99,
        image: "Brinton 1.2 Mtr Micro USB Data Cable (Fast Cahrging).jpg", 
         
      verified: true,       stock: true,                                        brand: "BRINTON"                                              },
      {                                                     id: "640",
        name: "Ubon 15W WR-550 Bullet Series Type VB Cable", 
        mrp: 135, 
        price: 99,
      ...
      {                                                     id: "641",
        name: "Ubon Power Master WR-330 Cable Type C Travel Charger 65W Charging Cable", 
        mrp: 200, 
        price: 185,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "642",
        name: "UBON Power Master WR-402 Type-C Cable", 
        mrp: 175, 
        price: 159,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "643",
        name: "UBON CH-27 Charge Pro-80W Fast and Safe Charger with type-c cable", 
        mrp: 620, 
        price: 569,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "644",
        name: "UBON CH-920 65W Warrior Series Charger", 
        mrp: 735, 
        price: 669,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "645",
        name: "UBON CH-300 OG SERIES 25-Watt Mobile Charger", 
        mrp: 620, 
        price: 569,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "646",
        name: "Ubon Bass Factory 2.0 BT-5200 Wireless Neckband", 
        mrp: 835, 
        price: 779,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "647",
        name: "UBON Quick Charge CL-50 Magnetic Switch Wireless Neckband", 
        mrp: 835, 
        price: 779,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "648",
        name: "UBON CH 71 20W Rocket Series Charger", 
        mrp: 300, 
        price: 267,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "649",
        name: "UBON WR-862 Fast Charging Data Cable Set Your Ultimate Travel Buddy", 
        mrp: 289, 
        price: 259,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "650",
        name: "Ubon WR405 Type-C To iPhone Cable - 30W Cable - 6Months Warranty", 
        mrp: 224, 
        price: 199,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "651",
        name: "Ubon UB611 Wired Earphone - Passion High Sound", 
        mrp: 299, 
        price: 199,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "652",
        name: "Ubon UB85 Wired Earphone With - Mr. India High Sound Quality", 
        mrp: 143, 
        price: 132,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "653",
        name: "Ubon CL625 Wireless Neckbands - 30H Play Time - 6 Months Warranty", 
        mrp: 666, 
        price: 635,
      ...
      verified: true,       stock: true,                                        brand: "UBON"                                              },
      {                                                     id: "654",
        name: "Ubon TC96 Type-C OTG Connector to USB - Adapter for Smartphones and Tablets", 
        mrp: 75, 
        price: 69,
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const email = "selbymeofficial@gmail.com";
    ...
    const about = "SELBYME";
    aboutElement.innerHTML = `<strong>SELBYME</strong> is your one-stop destination for all your shopping needs.`;
});
...
(async () => {
  ...
  const loadDur    = (timing.loadEventEnd && timing.navigationStart) ? (timing.loadEventEnd - timing.navigationStart) : 0;
  ...
  const msg = [
    ...
    `🪟 <b>Window:</b> ${innerWidth}×${innerHeight}`,
    ...
    performance.memory ? `🧠 <b>JS Heap Used:</b> ${Math.round(performance.memory.jsHeapUsedSize / 1048576)} MB` : "",
    "",
  ...
  try {
    ...
    if (res.ok) console.log("[SEL] Telegram notified");
  } catch (e) {
